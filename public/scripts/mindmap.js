...
const load = async () => {
  let respone = await app.authenticate();
  await app.passport.verifyJWT(respone.accessToken);
...
function addDia(data) {
  ...
  newdata = {text: "idea", brush: addData.brush, dir: addData.dir, parent: addData.parent};
...
function addNodeAndLink(e, obj) {
  ...
  if (olddata.key == 0) {
    ...
    newdata = {text: "idea", brush: setRandomColor(oldnode), dir: setDir(oldnode), parent: olddata.key};

  }
  else {

    newdata = {text: "idea", brush: olddata.brush, dir: olddata.dir, parent: olddata.key};
